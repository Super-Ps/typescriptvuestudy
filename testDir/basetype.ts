...
// 根据特定的名称得到对应的枚举数值
let mutest: Tester=Tester.Auto+100

let colorName: string = Tester[10] // 这里访问的不是枚举值的索引，而是通过值来获取变量名
...
function getLengtherror(x: number | string) {
